...
--
-- Class DaySchedule as table day_schedule
--
...
--
-- Class Progress as table progress
--
...
--
-- Class WeekSchedule as table week_schedule
--
...
--
-- Foreign relations for "day_schedule" table
--
...
--
-- Foreign relations for "progress" table
--
...
--
-- Foreign relations for "week_schedule" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('workouts_reminder', '20260118093634553', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260118093634553', "timestamp" = now();
